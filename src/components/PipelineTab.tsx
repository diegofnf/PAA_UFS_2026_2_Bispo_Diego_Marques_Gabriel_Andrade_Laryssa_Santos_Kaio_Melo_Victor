  ...
  const etapas = [
    ...
    },
    {
      ...
      metricas: [
        ...
        'Medição in-process, sem custo de inicialização do interpretador',
        'Carga 1: corpus integral (182 chunks); Carga 2: subconjunto (91)',
        'Tempo e pico de memória por execução, com ambiente registrado',
      ],
    ...
    },
    {
      ...
      descricao: 'Consolidação dos relatórios das etapas anteriores em tabelas CSV e figuras de análise.',
      status: 'Concluído',
      tempo: '7 gráficos + 2 CSVs',
      metricas: [
        'Tabela de resultados consolidada em CSV, com tempo por carga',
    ...
    {
      numero: '7',
      nome: 'Análise Assintótica do Pipeline',
      descricao: 'Medição de cada uma das 8 etapas do pipeline em função do tamanho de entrada, com ajuste por mínimos quadrados e classificação pelo expoente log-log.',
      status: 'Concluído',
      tempo: '8 estágios',
      metricas: [
        'Ajuste O(1), O(log n), O(n), O(n log n) e O(n²) por estágio',
        'Classificação pelo expoente, não pelo R², por limitação da faixa de n',
        'Extração, normalização, chunking, indexação, buscas, Merge Sort e Top-k',
        'Curvas em escala log-log contra os modelos teóricos',
      ],
      arquivo: '1_scripts/7_analise_assintotica.py',
    },
  ];
